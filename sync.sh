...
git_init(){
    git config --global user.name "Eric Lv"
    git config --global user.email "eric.lv@aeric.io"
    git remote rm origin
    git remote add origin git@github.com:yeaheo/gcr.io.git
    git pull
